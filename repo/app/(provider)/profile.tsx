...
export default function ProviderProfileScreen() {
  ...
  const handleSelectCountry = async (code: string) => {
    ...
    try {
      ...
      Alert.alert('خطأ', 'تعذّر تحديث الدولة، يرجى المحاولة مجدداً');
    } finally {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsRow}>
          ...
          >
            ...
            <View style={styles.countryValRow}>
        ...
        >
          <View style={styles.modalSheet}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                const isSelected = (providerUser?.country || 'SA') === item.code;
                return (
                  <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  countryValRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  ...
  modalSheet: {
    ...
    paddingTop: 12, paddingHorizontal: 16, paddingBottom: 40, maxHeight: '70%',
  },
  modalHandle: {
  ...
  countryCode: {
    fontFamily: 'Cairo_700Bold', fontSize: 14, color: Colors.textMuted,
    width: 40, textAlign: 'center',
  },
  countryCodeSelected: { color: Colors.primary },
  countryName: {
    flex: 1, fontFamily: 'Cairo_400Regular', fontSize: 14,
    color: Colors.textPrimary, textAlign: 'right',
  },
  countryNameSelected: { fontFamily: 'Cairo_600SemiBold', color: Colors.primary },
});
