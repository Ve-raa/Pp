        ...
        >
          ...
          <View style={styles.earningsBanner}>
            ...
            <View>
              ...
              <Text style={styles.earningsAmount}>{dashboard?.totalEarnings?.toFixed(2) || '0.00'}د.إ</Text>
              <Text style={styles.earningsMonth}>
                هذا الشهر: {dashboard?.thisMonthEarnings?.toFixed(2) || '0.00'}د.إ
              </Text>
            </View>
          </View>
              ...
              {dashboard.recentOrders.slice(0, 5).map((order) => (
                <View key={order.id} style={styles.orderRow}>
                  ...
                  <View style={styles.orderInfo}>
                    ...
                    <Text style={styles.orderTotal}>{order.total?.toFixed(2)}د.إ</Text>
                  </View>
                </View>
              ))}
            </View>
